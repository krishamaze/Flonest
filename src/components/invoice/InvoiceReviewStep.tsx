            ...
            <div>
                        ...
                        return (
                            ...
                            >
                                <div className="flex justify-between text-sm">
                                    ...
                                    <span className="font-medium text-primary-text">{CURRENCY_SYMBOL}{item.line_total.toFixed(2)}</span>
                                </div>
                ...
                <div className="mt-lg pt-md border-t border-neutral-200 space-y-sm">
                    <div className="flex justify-between text-sm">
                        ...
                        <span className="font-medium text-primary-text">{CURRENCY_SYMBOL}{totals.subtotal.toFixed(2)}</span>
                    </div>
                        ...
                        <>
                            {totals.cgst_amount > 0 && (
                                <div className="flex justify-between text-sm">
                                    ...
                                    <span className="font-medium text-primary-text">{CURRENCY_SYMBOL}{totals.cgst_amount.toFixed(2)}</span>
                                </div>
                            )}
                            {totals.sgst_amount > 0 && (
                                <div className="flex justify-between text-sm">
                                    <span className="text-secondary-text">SGST</span>
                                    <span className="font-medium text-primary-text">{CURRENCY_SYMBOL}{totals.sgst_amount.toFixed(2)}</span>
                                </div>
                            )}
                            {totals.igst_amount > 0 && (
                                <div className="flex justify-between text-sm">
                                    <span className="text-secondary-text">IGST</span>
                                    <span className="font-medium text-primary-text">{CURRENCY_SYMBOL}{totals.igst_amount.toFixed(2)}</span>
                                </div>
                            )}
                        </>
                    )}
                    ...
                    <div className="flex justify-between text-lg font-semibold pt-sm border-t border-neutral-200">
                        ...
                        <span className="text-primary-text">{CURRENCY_SYMBOL}{totals.total_amount.toFixed(2)}</span>
                    </div>
                    {items.some(item =>
